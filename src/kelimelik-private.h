...
#define _KELIMELIK_ERROR_DIFFERENT_FORMAT _KELIMELIK_ERROR(KELIMELIK_ERROR_DIFFERENT_FORMAT, 0)
#define _KELIMELIK_ERROR_INVALID_FORMAT _KELIMELIK_ERROR(KELIMELIK_ERROR_INVALID_FORMAT, 0)
